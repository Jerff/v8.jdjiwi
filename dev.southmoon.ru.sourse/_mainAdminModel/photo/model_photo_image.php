...
//        self::updateWhere($id);
//        cmfRegister::getSql()->placeholder("UPDATE ?t p SET p.image_section=(SELECT i.image_section FROM ?t i WHERE i.product=p.id AND visible='yes' ORDER BY i.pos DESC LIMIT 0, 1),
