...
//                    $content = file_get_contents('http://www.russianpost.ru/resp_engine.aspx?Path=rp/servise/ru/home/postuslug/trackingpo', false, $context);
                    $content = cmfFile::curl('http://www.russianpost.ru/resp_engine.aspx?Path=rp/servise/ru/home/postuslug/trackingpo', $post);
...
//                    pre($data);
                    ...
                    $sql->add(db_basket, array('deliveryDesc'=>cmfString::serialize($data)), $basket['id']);
