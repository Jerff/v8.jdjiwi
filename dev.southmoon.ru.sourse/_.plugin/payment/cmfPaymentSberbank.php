...
bgColor=#ffffff border=1>
  ...
  <TR>
    ...
    <B>&nbsp;Плательщик:</B>&nbsp;<span id="name1"><?=$fio ?></span><input id="input1" type="text" class="cmfHide width50" value="<?=cmfString::specialchars($fio) ?>"></TD></TR>
  <TR>
  ...
  <TR>
    ...
    &nbsp;<B>Плательщик:</B>&nbsp;<span id="name2"><?=$fio ?></span><input id="input2" type="text" class="cmfHide width50" value="<?=cmfString::specialchars($fio) ?>"></TD></TR></TBODY></TABLE></CENTER></DIV>
