		...
		<table style="border-collapse:collapse;">
			<tr style="background:#f1f5fa;">
				...
				<td style="padding:10px">
					...
					<input name="com" type="hidden" value="<?=cmfString::specialchars($desc) ?>">
			...
			<tr style="background:#f1f5fa;">
				...
				<td style="padding:10px"><textarea rows="2" cols="30" name="com" style="width:200px; border: 1px inset #555;"><?=cmfString::specialchars($desc) ?></textarea></td>
			</tr>
		</table>
